...
func rolloutAndValidateOnboarding(t *testing.T, s *fixtures.ExpectedServices, a action) {
	...
	// crc := framework.Global.IstioClientset.Get(collections.IstioSecurityV1Beta1Authorizationpolicies.Resource().GroupVersionKind(), constants.DefaultRbacConfigName, "")
