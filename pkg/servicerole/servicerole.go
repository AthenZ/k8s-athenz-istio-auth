...
func PatchServiceRole(client dynamic.Interface, serviceRole model.Config, domain string, tag string) error {

	ns := serviceRole.Namespace
	...
	patch := []byte(fmt.Sprintf(`
		...
		}`, domain, tag, util.ComputeHash(serviceRole)))
